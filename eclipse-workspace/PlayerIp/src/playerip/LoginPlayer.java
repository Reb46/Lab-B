...
public class LoginPlayer {
	...
	public LoginPlayer(Proxy proxy) {
		...
		JLabel lblTextLogin = new JLabel("IP - LOGIN PLAYER");
		...
		JLabel lblLinkPlayer = new JLabel("Non hai un account? Clicca per registrarti");
		lblLinkPlayer.setFont(new Font("Century Gothic", Font.BOLD, 11));
		lblLinkPlayer.setBounds(81, 228, 269, 13);
		frame.getContentPane().add(lblLinkPlayer);

		JLabel lblForgotPassw = new JLabel("Non ricordi la password? Clicca qui");
		...
		lblLinkPlayer.addMouseListener(new MouseAdapter() {
