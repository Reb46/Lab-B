...
public class PleaseWait {
	...
	public PleaseWait(Proxy proxy,String email,String nameGame)  {
		...
		ImageIcon loading = new ImageIcon("attendi.gif");
		nick = proxy.getNick(email);
		nomePartita = nameGame;
		frmPlease.getContentPane().setLayout(null);
		JLabel lblPleaseAwait = new JLabel("Attendi l'inzio del match " + nick, loading, JLabel.HORIZONTAL);
		...
		JLabel lblTitle = new JLabel("IL PAROLIERE");
		...
		JLabel lblInfo = new JLabel("COMPLIMENTI SEI STATO AGGIUNTO ALLA PARTITA");
		...
		btnExit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(response == JOptionPane.YES_OPTION) {
					String result = proxy.setAbbandono(nomePartita, nick); // se abbandono la partita e sono l'unico iscritto vengo eliminata la partita
